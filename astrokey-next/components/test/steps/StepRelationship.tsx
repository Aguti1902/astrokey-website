...
import { Gem, Diamond, Heart, HelpCircle, User, HeartCrack } from 'lucide-react'

const options = [
  { value: 'casado', label: 'Casado/a', Icon: Diamond },
  { value: 'comprometido', label: 'Comprometido/a', Icon: Gem },
  { value: 'en-relacion', label: 'En una relación', Icon: Heart },
  { value: 'complicado', label: 'Complicado', Icon: HelpCircle },
  { value: 'soltero', label: 'Soltero/a', Icon: User },
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-lg mx-auto">
        {options.map(({ value, label, Icon }) => {
          ...
          return (
            <button
              key={value}
              onClick={() => setTestAnswer('relationshipStatus', value)}
              className={cn(
