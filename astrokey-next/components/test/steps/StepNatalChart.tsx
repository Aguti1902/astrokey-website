...
const options = [
  { value: 'si', label: 'Sí, me la han hecho', Icon: CheckCircle, color: 'text-emerald-400' },
  { value: 'no', label: 'No, nunca', Icon: XCircle, color: 'text-rose-400' },
]
      ...
      <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
        {options.map(({ value, label, Icon, color }) => {
          ...
          return (
            <button
              key={value}
              onClick={() => setTestAnswer('hasNatalChart', value)}
              className={cn(
