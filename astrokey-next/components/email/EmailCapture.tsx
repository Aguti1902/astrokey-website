        ...
        <div className="max-w-md w-full">
          ...
          >
            ...
            <p className="text-white/50">
              {chartResult ? (
                <>Tu signo solar es <span className="text-primary-400 font-semibold">{chartResult.sunSign}</span>. Introduce tu email para recibir los resultados completos.</>
              ) : (
                'Introduce tu email para recibir tus resultados personalizados.'
              )}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="mt-6 space-y-3">
              {['Tu carta astral personalizada', 'Análisis de personalidad', '2 días de acceso completo'].map((text) => (
          ...
          >
            ...
            No spam. Tu email está protegido.
          </motion.div>
        </div>
      </div>
    </div>
